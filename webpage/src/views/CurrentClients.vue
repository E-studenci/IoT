...
export default {
    ...
    methods: {
        findPendingClients() {
            ...
            fetch("http://127.0.0.1:5000/visit/get_pending", requestOptions)
            .then((res) => {
                if(res.ok) {
                    return res.json()
                }
        ...
        findOngoingClients() {
            ...
            fetch("http://127.0.0.1:5000/visit/get_ongoing", requestOptions)
            .then((res) => {
                if(res.ok) {
                    return res.json()
                }
        ...
        deletePendingClient(id) {
            var myHeaders = new Headers();
            myHeaders.append("Cookie", document.cookie);
            var url = "http://127.0.0.1:5000/visit/confirm/" + id
